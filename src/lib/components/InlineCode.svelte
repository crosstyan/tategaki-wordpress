<script lang="ts">
  ...
  // Tooltip
  // TODO: maybe it's better to use `use:tooltip` instead of component
</script>

<Tooltip title={codeElem.innerText}>
  <span
    class="code text-gray-200 text-sm font-mono font-light my-1 py-2 bg-gray-600 no-underline"
